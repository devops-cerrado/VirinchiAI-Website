    ...
    <section className="relative overflow-hidden" style={{ background: "linear-gradient(135deg, hsl(185 55% 45%), hsl(268 45% 48%))" }}>
      ...
      <div className="relative max-w-4xl mx-auto text-center section-padding">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button onClick={() => setShowVideo(true)} className="border-2 border-primary-foreground text-primary-foreground px-8 py-3.5 rounded-lg font-semibold text-sm hover:bg-primary-foreground/10 transition-colors">
            Watch 3-Min Demo →
          </button>
        </div>
      </div>
