...
export const solutions: Solution[] = [
  { name: "Virinchi PA", description: "Predictive analytics for Risk Management. Predict, not react.", icon: TrendingUp },
  ...
  { name: "Virinchi Legal & Document Review", description: "Easy management of contracts and MSAs. Track all contract documents in one place.", icon: Scale },
];
